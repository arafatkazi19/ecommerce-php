...
<div class="menu-wrap">
  ...
  <ul class="sf-menu">
    <li>
      <a href="http://localhost/ecom/index.php">Home</a>
    </li>
    <li>
      <a href="#">Shop</a>
    ...
    <li>
      ...
      <div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
      <ul>
        <li><a href="http://localhost/ecom/my-account.php">My Orders</a></li>
        <li><a href="http://localhost/ecom/edit-address.php">Update Address</a></li>
        <li><a href="http://localhost/ecom/logout.php">Logout</a></li>
      </ul>
    </li>
    <li>
      <a href="#">Contact</a>
